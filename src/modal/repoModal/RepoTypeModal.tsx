...
const RepoModal = ({isTypeModalOpen, onTypeCloseModal, modalTitle, type, setType}: IRepoModalProps) => {
    ...
    return (
        <Modal isModalOpen={isTypeModalOpen} onCloseModal={onTypeCloseModal} modalTitle={modalTitle} modalClassName="absolute w-50 ml-122 -mt-110 p-4" titleClassName="text-sm font-bold">
            {types.map((item) => (
