...
const RepoModal = ({repoData, isModalOpen, onCloseModal, modalTitle, repoItem, setRepoItem, getPopularRepos}: IRepoModalProps) => {
    ...
    return (
        <Modal isModalOpen={isModalOpen} onCloseModal={onCloseModal} modalTitle={modalTitle} backModalClassName="justify-center fixed items-center bg-black/30" modalClassName=" relative w-120 h-160 p-6" titleClassName="text-lg">
